      ...
      <div className="portal-page xtremeos-content" style={{ background: '#f7f7f5', minHeight: '100vh', marginLeft: 240 }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#aaa', fontSize: 14, margin: 0 }}>Build a list of sites to clone. The autonomous processor clones, validates to 100/100, and runs a forensic audit before adding to the gallery.</p>
          </div>
        ...
        {cleanupResult && (
          <div style={{
            background: '#fff', border: '1px solid #ddd', borderRadius: 10, padding: 20, marginBottom: 20,
          }}>
        ...
        {showAdd ? (
          ...
          <button onClick={() => setShowAdd(true)} style={{
            ...
            <Plus size={16} /> Add Site to Queue
          </button>
        )}
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 60, color: '#999' }}>
            ...
            <p style={{ fontSize: 13, color: '#aaa' }}>Add sites above, or run "Cleanup Broken Clones" to move broken clones here for re-cloning.</p>
          </div>
        ) : (
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ background: '#f8f7f4', borderBottom: '1px solid #eee' }}>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Site</th>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Industry</th>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Status</th>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Score</th>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Priority</th>
                  <th style={{ textAlign: 'left', padding: '12px 16px', fontSize: 11, textTransform: 'uppercase', color: '#888' }}>Source</th>
                  ...
                  <tr key={item.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                    ...
                    <td style={{ padding: '12px 16px' }}>
                      <button onClick={() => handleDelete(item.id)} style={{
                        background: 'none', border: 0, cursor: 'pointer', padding: 4, color: '#C63D34',
                      }}>
                        <Trash2 size={16} />
                      </button>
                    </td>
...
const inputStyle = {
  padding: '10px 12px', border: '1px solid #d7d7d7', borderRadius: 6,
  fontSize: 14, fontFamily: 'inherit', background: '#fff', color: '#111', outline: 'none',
};
