    ...
    <MarketingShell>
      <section className="bg-[#000000] text-white py-20">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <p className="mt-5 text-lg text-slate-300">From the first click to the fifth repeat sale, AUTO LEADS is tuned to the way local service businesses win work.</p>
        </div>
      </section>
