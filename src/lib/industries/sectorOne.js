...
export const SECTOR_ONE_INDUSTRIES = [
  ...
  {
    id: 'epoxy-coatings', label: 'Epoxy Coatings', group: 'Construction & Contracting',
    scopes: [
      ...
      'Urethane Cement / Mortar Systems',
      ...
      'Concrete Sealing & Densifiers',
      'Epoxy Crack Repair & Joint Fill',
      'Static-Control (ESD) Flooring',
    ],
    businesses: [
      { name: 'Garage Kings', url: 'https://garagekings.com' },
      { name: 'ArmorPoxy', url: 'https://armorpoxy.com' },
      { name: 'SPF Epoxy', url: 'https://spfepoxy.com' },
      { name: 'Art of Coating Miami', url: 'https://artofcoatingmiami.com' },
      { name: '343 Epoxy', url: 'https://343epoxy.com' },
      { name: 'Americas Industrial Coatings', url: 'https://americasindustrialcoatings.com' },
    ],
  },
  {
    id: 'decorative-concrete', label: 'Decorative Concrete', group: 'Construction & Contracting',
    scopes: [
      'Stamped Concrete',
      'Polished Concrete',
      'Stained Concrete (Acid & Water-Based)',
      'Concrete Overlays (Troweled & Sprayed)',
      'Micro-Toppings',
      'Self-Leveling Overlays',
      'Terrazzo Flooring',
      'Concrete Resurfacing',
      'Knockdown Texture Finishes',
      'Pool Deck & Patio Finishes',
      'Driveway Stamping & Coloring',
      'Interior Polished Concrete',
      'Commercial Concrete Polishing',
      'Venetian Plaster Finishes',
      'Concrete Countertops',
      'Decorative Sawcutting & Jointing',
      'Vertical Concrete Overlays',
      'Concrete Sealing & Wet-Look Finishes',
    ],
    businesses: [
      { name: 'Bomanite', url: 'https://bomanite.com' },
      { name: 'Decorative Concrete of Virginia', url: 'https://decorativeconcreteofvirginia.com' },
      { name: 'OCD Painting and Flooring', url: 'https://ocdpaintingandflooring.com' },
      { name: 'Wichita Concrete Pros', url: 'https://wichita-concretepros.com' },
    ],
  },
