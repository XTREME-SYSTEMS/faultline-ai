...
export const COATING_SYSTEMS = [
  ...
  { id: 'medici', name: 'Medici® System', desc: 'The Medici® Polyurea Coating System creates a custom, decorative finish that will outlast any other acrylic or acid stain system on the market. This system is easy to maintain without waxing or re-coating.', image: 'https://garageforce.com/wp-content/uploads/2024/02/Medici-Patio.png', systemKey: 'flake' },
...
export const TESTIMONIALS = [
  { text: "We have a two car garage in an older condo development. We researched various floor treatments for upgrading the appearance and utility of our garage. GarageForce made the best case for the quality and durability of their process. The bonus was a lifetime warranty that other epoxy vendors were not offering. After a site visit and very reasonable estimate they were able to schedule us for installation. The crew came out precisely at the time scheduled and got to work promptly. The final result is everything promised. Flawlessly installed with enough tooth to the floor to ensure a relatively no-slip surface without losing the gloss.", author: "Beacher2" },
  { text: "From sales to completion, Garage Force did an excellent job on our garage floor. We are enjoying the finished product, and have peace of mind knowing that the work is covered by a lifetime warranty. Thanks for a job well-done!", author: "Michael Kohen" },
  { text: "Excellent work by Garage Force. On time, friendly, great work and the results are amazing.", author: "Brian Hunnius" },
  { text: "Our garage floor looks beautiful! Only regret is that we didn't do it sooner! Thank you garage force team!", author: "Nicole Niven" },
  { text: "Garage Force did an excellent job of communicating with me. They were on time and the results are great.", author: "Mark Nash" },
  { text: "I got quotes from multiple companies before deciding on Garage Force. One of the main reasons was how responsive our local expert was — he was the only one to consistently respond within 24 hours. His pricing was transparent and up-front. I would use Garage Force again in the future.", author: "Seth Kinast" }
];
