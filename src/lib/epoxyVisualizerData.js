...
export const COATING_SYSTEMS = [
  { id: 'flake', name: 'Full Chip System', desc: 'The Full Chip, or Decorative Chip, System is our most popular concrete coating system. This three-layer system is easy to install in as little as 2 days and you\'ll be back on your floor in just 24 hours!', image: 'https://garageforce.com/wp-content/uploads/2022/11/square-full-chip.png', systemKey: 'flake' },
  { id: 'medici', name: 'XPS Signature Flex System', desc: 'The XPS Signature Flex Coating System creates a custom, decorative finish that will outlast any other acrylic or acid stain system on the market. This system is easy to maintain without waxing or re-coating.', image: 'https://garageforce.com/wp-content/uploads/2022/11/garageforce-41.jpg', systemKey: 'flake' },
...
export const TESTIMONIALS = [
  { text: "We have a two car garage in an older condo development. We researched various floor treatments for upgrading the appearance and utility of our garage. XPS made the best case for the quality and durability of their process. The bonus was a 10 year warranty that other epoxy vendors were not offering. After a site visit and very reasonable estimate they were able to schedule us for installation. The crew came out precisely at the time scheduled and got to work promptly. The final result is everything promised. Flawlessly installed with enough tooth to the floor to ensure a relatively no-slip surface without losing the gloss.", author: "Beacher2" },
  { text: "From sales to completion, XPS did an excellent job on our garage floor. We are enjoying the finished product, and have peace of mind knowing that the work is covered by a 10 year warranty. Thanks for a job well-done!", author: "Michael Kohen" },
